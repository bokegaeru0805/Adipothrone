Shader "AllIn1SpriteShader/AllIn1SpriteShaderCustom"
{
    Properties
    {
        ...
        Pass
        {
            ...
            half4 frag (v2f i) : SV_Target
            {
				...
				* max(sign((_ShineLocation + _ShineWidth) - currentDistanceProjection), 0.0) * _ShineColor * shineMask;
                ...
                //全ての計算が終わった最終的な色(col)に対して、フラッシュ効果を合成する
                #if FLASH_ON
	...
	CustomEditor "AllIn1SpriteShaderWithFlashInspector"

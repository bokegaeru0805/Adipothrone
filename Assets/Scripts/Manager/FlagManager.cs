...
public class FlagManager : MonoBehaviour
{
    ...
    private static readonly List<DoorUnlockCondition> doorConditions =
        new()
        {
            ...
            {
                doorId = 14,
                requiredKeys = new List<KeyID> { KeyID.K14 },
            },
            new DoorUnlockCondition
            {
                doorId = 15,
                requiredKeys = new List<KeyID> { KeyID.K15 },
            },
        };
    ...
    public void SetChapter2TriggeredEvent(Chapter2TriggeredEvent flag, bool value)
    {
        SetBoolFlag(flag, value);
    }
